...
//                node.setStyle(Q.Styles.SHAPE_FILL_COLOR, "#FFF");
    node.setStyle(Q.Styles.SHAPE_FILL_COLOR, Q.toColor(0x88FFFFFF));
...
function init() {
    ...
    Q.loadJSON("/static/json/shanghai_metro_data.json", function (metroData) {
...
function onlayerchange(evt){
    ...
    Q.loadJSON("/static/json/shanghai_metro_status.json", function(json){
        lineStatus.forEach(function(line){
            graph.removeElement(line);
        });
